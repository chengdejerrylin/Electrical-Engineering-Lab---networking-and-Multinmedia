...
x_train, y_train, y_value, x_test, y_test, _ = datasets.getBigML("MNIST", ratio)#, getAbsPath("../BigML/MNIST_results")
...
control.save(getAbsPath("model/origin_mnist_BigML.model"))
...
copy.save(getAbsPath("model/copy_mnist_BigML.model"))
